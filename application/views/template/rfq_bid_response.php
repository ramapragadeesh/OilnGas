...
<p>
This is an unsolicited email that Abrasivesworld is authorised to distribute either on behalf of the sender (in copy) or by you as a member of Abrasivesworld. Please visit <a href="http://abrasivesworld.com/abrasivesworld/contact_us">http://abrasivesworld.com/abrasivesworld/contact_us</a> to report any abuse or mis-use.
</p>
<hr/>
<p>
You have received Bid response for the following RFQ.Please click the link below to know more information about this bid response
<br/>
</p>
<a href="<?php echo base_url();?>rfq/rfq_bid_info/?rfqid=<?php echo $rfq_id;?>&user_bid_id=<?php echo $rfq_bid_id;?>">
<?php
echo $rfq_title;
?>
<a/>
