...
<hr/>
<p>
Your authorization is required for the following Article Group Sending
<br/>
</p>
<a href="<?php echo base_url();?>my_article/admin_auth/?article_id=<?php echo $art_id;?>&article_new=false">
<?php
echo $art_title;
?>
<a/>
