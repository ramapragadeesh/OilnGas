...
function populate_docs(& $dd,& $l) {
	...
	foreach ($dd as &$value) 
	{
		$r .='<tr><td>'.$value->rfq_filename.'</td><td><a href="'.$value->rfq_linkname.'" target="_blank"> <i class="fa fa-cloud-download"></i> Download</a>
			  </td></tr>
		';
	}
	return $r;
...
<script>
	$(document).ready(function() {
		$('#rfq_issuedate').datepicker();
		$('#rfq_closedate').datepicker();
...
<div class="container" style="background:whitesmoke">
	...
	<div id="mainFormRFQ">
		<div id="rfqLabel">
			<h2 style="font-weight:100"><?php echo dp($info_holder,"RFQ Bidding Response for ");?> <?php echo $rfqm[0]->rfq_title;?></h2>    	
		</div>
