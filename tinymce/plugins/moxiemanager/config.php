<?php
	// General
	$moxieManagerConfig['general.license'] = 'IN55-VMOX-K76T-DBJZ-ZMVQ-THUP-B2NM-VDJJ';
	...
	$moxieManagerConfig['filesystem.extensions'] = 'ogg,mp4,wmv,flv,mov,ing,jpg,jpeg,png,gif,html,htm,txt,docx,doc,zip,pdf';
	...
	$moxieManagerConfig['upload.max_width'] = 10000;
	$moxieManagerConfig['upload.max_height'] = 10000;
	...
	$moxieManagerConfig['thumbnail.jpeg_quality'] = 90;
	...
	// Local filesystem
	$moxieManagerConfig['filesystem.local.wwwroot'] = '/home/content/64/11453264/html';
